...
#	sed -i.bak 's|"zipkincore"|"$(JAEGER_IMPORT_PATH)/thrift-gen/zipkincore"|g' $(JAEGER_THRIFT_GEN_DIR)/agent/*.go
#	sed -i.bak 's|"jaeger"|"$(JAEGER_IMPORT_PATH)/thrift-gen/jaeger"|g' $(JAEGER_THRIFT_GEN_DIR)/agent/*.go
